...
1. MIN_PRIORITY: Minimum priority that a thread can have. Value is 1.

2. NORM_PRIORITY: This is the default priority automatically assigned by JVM to a thread if a programmer does not explicitly set the priority of that thread. Value is 5.

3. MAX_PRIORITY: Maximum priority that a thread can have. Value is 10.
