...
https://www.codewithharry.com/videos/java-tutorials-for-beginners-13/

In the diagram on website, notice that string "Harry" is already present in the string pool, which is pointed by the 'str1'. When we try to create the same string object using 'str2', JVM finds that string object with the value "Harry" is already present in the string pool; therefore, instead of creating a new object, a reference to the same object is returned.
...
System.out.format()
System.out.printf("The respective values are : %d, %f, %c", int, fl, ch);
//   %d for int
//   %f for float
//   %c for char
//   %s for string 
